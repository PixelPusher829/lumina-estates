				...
				<div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
					...
					<div className="lg:w-1/2 relative z-10">
						...
						<p className="text-lg text-slate-600 leading-relaxed mb-8">
							Finding a home is about finding your place in the world. Our
							bespoke search process combines AI-driven market analysis with
							human intuition to uncover off-market gems and negotiate the best
							possible terms.
						</p>
