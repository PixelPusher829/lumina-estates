...
import { Target, Users, Award, TrendingUp, Phone, Mail, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen pt-28 pb-20 bg-white">
      ...
      <div className="container mx-auto px-6 mb-20">
        <div className="max-w-4xl mx-auto text-center">
           <span className="text-primary-600 font-bold tracking-wider text-sm uppercase mb-4 block">Our Story</span>
           <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-8 leading-tight">Redefining luxury real estate for the modern era.</h1>
           <p className="text-xl text-slate-500 leading-relaxed">
             Lumina Estates was founded on a simple belief: finding a home should be an inspiring journey, not a stressful transaction. We combine technology, design, and human connection to create a seamless experience.
           </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
               <div>
                  ...
                  <p className="text-slate-600 leading-relaxed mb-6">
                    We strive to empower our clients with data-driven insights and curated opportunities. Whether you are buying your first apartment or investing in a commercial portfolio, our goal is to maximize your value and peace of mind.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    Integrity, transparency, and innovation are at the core of everything we do. We believe in building long-term relationships that extend far beyond the closing table.
                  </p>
               </div>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
           <h2 className="text-4xl font-bold text-slate-900 mb-4">Meet Our Agents</h2>
                 ...
                 <div key={idx} className="bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 group">
                    <div className="aspect-square overflow-hidden relative">
                       ...
                       <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-6">
                          <Link to="/contact" className="w-full py-3 bg-white text-slate-900 font-bold rounded-xl text-center hover:bg-slate-100 transition-colors">
                    ...
                    <div className="p-6">
                       ...
                       <p className="text-slate-500 text-sm mb-6">Senior Real Estate Agent</p>
