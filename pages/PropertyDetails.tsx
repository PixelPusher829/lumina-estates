...
import { 
  ArrowLeft, MapPin, Bed, Bath, Move, CheckCircle2, 
  Share2, Heart, ChevronLeft, ChevronRight, ImageIcon 
} from 'lucide-react';
...
const PropertyDetails: React.FC<PropertyDetailsProps> = ({ favorites, toggleFavorite }) => {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center text-slate-500 pt-20">Loading property details...</div>;
  if (!property) return <div className="min-h-screen flex items-center justify-center text-slate-500 pt-20">Property not found.</div>;
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 mb-8 lg:mb-12 h-auto lg:h-[500px]">
           ...
           <div className="hidden lg:flex flex-col gap-4 h-full">
              {sideImages.map((img, idx) => (
                ...
                >
                  <img src={img.src} alt="Gallery thumbnail" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
          ...
          <div className="lg:col-span-4 relative">
             <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/40">
                   <div className="mb-6">
                      <span className="text-3xl font-bold text-slate-900">{property.currency}{property.price.toLocaleString()}</span>
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
                   ...
                   <div>
                      ...
                      <div className="flex gap-2 mt-1">
                         <span className="text-primary-600 cursor-pointer hover:underline text-xs font-semibold">View Profile</span>
                      </div>
                   </div>
                </div>
